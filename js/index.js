// pertama menginisialisasi dahulu ke variable dengan document
...
const localMaximumAttemptsKey = 'LOCAL_MAXIMUM_ATTEMPS';
...
destroyDataButton.addEventListener('click',function (){
    ...
    alert('refresh dong, kalau mau main lagi mah');
})